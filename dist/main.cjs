...
$parcel$export(module.exports, "StimulusX", () => $4f4b2c77fca8d6f7$export$2e2bcd8739ae039);
$parcel$export(module.exports, "nextTick", () => $8ac4d22a5034a28e$export$bdd553fddd433dcb);
...
function $8fc1b106fbc18952$export$dc573d8a6576cdb3(callback) {
    const effectInstance = new (0, $gXNCa$vuereactivity.ReactiveEffect)(callback, {
...
function $c4a194e961464110$export$21fc366069a4f56f(el) {
    el._x_effects?.forEach((0, $8ac4d22a5034a28e$export$edbe2d8b64bcb07c));
...
function $c6c15cd6b2ee5a2e$export$1dd40105af141b08(el, directive) {
    ...
    let wrapperHandler = (application)=>{
        let controller = $c6c15cd6b2ee5a2e$var$getClosestController(el, directive.identifier, application);
        if (controller) {
            handler = handler.bind(handler, el, directive, {
                ...utilities,
                evaluate: $c6c15cd6b2ee5a2e$var$evaluator(controller, el),
...
function $c6c15cd6b2ee5a2e$var$evaluator(controller, el) {
    return (property)=>{
...
function $c6c15cd6b2ee5a2e$var$getClosestController(el, identifier, application) {
...
function $4f4b2c77fca8d6f7$var$extend(application) {
    ...
    application.register = function(identifier, ControllerClass) {
        const controllerConstructor = $4f4b2c77fca8d6f7$var$createReactiveControllerClass(ControllerClass);
        application.load({
            identifier: identifier,
    ...
    (0, $c4a194e961464110$export$c395e4fde41c37ff)((el)=>$4f4b2c77fca8d6f7$var$initTree(el, application));
    ...
    (0, $c4a194e961464110$export$545f7104b1510552)((el, attrs)=>{
        $4f4b2c77fca8d6f7$var$handleValueAttributes(el, attrs, application);
        (0, $c6c15cd6b2ee5a2e$export$90a684c00f3df6ed)(el, attrs).forEach((handle)=>handle(application));
    });
    (0, $8ac4d22a5034a28e$export$bdd553fddd433dcb)(()=>{
        $4f4b2c77fca8d6f7$var$rootElements().forEach((el)=>$4f4b2c77fca8d6f7$var$initTree(el, application));
    });
}
function $4f4b2c77fca8d6f7$var$createReactiveControllerClass(ControllerClass) {
    return class extends ControllerClass {
        constructor(context){
            ...
            return (0, $8fc1b106fbc18952$re_export$reactive)(this);
        }
    };
}
...
function $4f4b2c77fca8d6f7$var$initTree(el, application) {
    (0, $c6c15cd6b2ee5a2e$export$3d81bdeca067fd2d)(()=>{
        $4f4b2c77fca8d6f7$var$walk(el, (el)=>{
            if (el._stimulus_x_marker) return;
            (0, $c6c15cd6b2ee5a2e$export$90a684c00f3df6ed)(el, el.attributes).forEach((handle)=>handle(application));
            el._stimulus_x_marker = $4f4b2c77fca8d6f7$var$markerCount++;
        });
    });
}
function $4f4b2c77fca8d6f7$var$destroyTree(root) {
    $4f4b2c77fca8d6f7$var$walk(root, (el)=>{
        (0, $c4a194e961464110$export$21fc366069a4f56f)(el);
        (0, $c4a194e961464110$export$2c8bfe603cc113da)(el);
        delete el._stimulus_x_marker;
    });
}
function $4f4b2c77fca8d6f7$var$walk(el, callback) {
    let skip = false;
    callback(el, ()=>skip = true);
    if (skip) return;
    let node = el.firstElementChild;
    while(node){
        $4f4b2c77fca8d6f7$var$walk(node, callback, false);
...
var $4f4b2c77fca8d6f7$export$2e2bcd8739ae039 = {
    extend: $4f4b2c77fca8d6f7$var$extend,
    modifier: $f144c181a48a989e$export$cd4b50bb4e5c05a3,
    directive: $c6c15cd6b2ee5a2e$export$99b43ad1ed32e735
};
...
function $24bc203a598583b5$export$2385a24977818dd0(element, name, value) {
    switch(name){
        // case "class":
        ...
        case "checked":
        case "selected":
            $24bc203a598583b5$var$bindAttributeAndProperty(element, name, value);
            break;
        default:
            $24bc203a598583b5$var$bindAttribute(element, name, value);
            break;
    }
}
...
// }
function $24bc203a598583b5$var$bindAttribute(el, name, value) {
    if ([
        null,
        undefined,
        false
    ].includes(value) && $24bc203a598583b5$var$attributeShouldntBePreservedIfFalsy(name)) el.removeAttribute(name);
    else {
        if ($24bc203a598583b5$var$isBooleanAttr(name)) value = name;
        $24bc203a598583b5$var$setIfChanged(el, name, value);
    }
}
// function bindAll(element, obj) {
//   Object.keys(obj).forEach((name) => bind(element, name, getProperty(obj, name)));
// }
function $24bc203a598583b5$var$bindAttributeAndProperty(el, name, value) {
    $24bc203a598583b5$var$bindAttribute(el, name, value);
    $24bc203a598583b5$var$setPropertyIfChanged(el, name, value);
}
function $24bc203a598583b5$var$setIfChanged(el, attrName, value) {
    if (el.getAttribute(attrName) != value) el.setAttribute(attrName, value);
}
function $24bc203a598583b5$var$setPropertyIfChanged(el, propName, value) {
    if (el[propName] !== value) el[propName] = value;
}
// As per HTML spec table https://html.spec.whatwg.org/multipage/indices.html#attributes-3:boolean-attribute
const $24bc203a598583b5$var$booleanAttributes = new Set([
    "allowfullscreen",
    "async",
    "autofocus",
    "autoplay",
...
function $24bc203a598583b5$var$isBooleanAttr(attrName) {
    return $24bc203a598583b5$var$booleanAttributes.has(attrName);
}
function $24bc203a598583b5$var$attributeShouldntBePreservedIfFalsy(name) {
    return ![
        "aria-pressed",
        "aria-checked",
        "aria-expanded",
...
(0, $c6c15cd6b2ee5a2e$export$99b43ad1ed32e735)("attr", (el, { property: property, subject: subject, modifiers: modifiers }, { effect: effect, evaluate: evaluate, modify: modify })=>{
    effect(()=>{
        (0, $c4a194e961464110$export$c98382a3d82f9519)(()=>{
            ...
            (0, $24bc203a598583b5$export$2385a24977818dd0)(el, subject, value);
        });
    });
});
