...
function $4f4b2c77fca8d6f7$var$handleValueAttributes(el, attrs) {
    ...
    for(let i = 0; i < attrs.length; i++){
        ...
        if (matches && matches.length) {
            ...
            const controller = $4f4b2c77fca8d6f7$var$StimulusX.application.getControllerForElementAndIdentifier(el, identifier);
