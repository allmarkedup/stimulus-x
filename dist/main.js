...
function $370754aea5bc9e6a$export$dc573d8a6576cdb3(callback) {
    const effectInstance = new (0, $ab22efe6fa499022$export$28352bb4dd362521)(callback, {
...
function $46a1f2608b4b91f0$export$21fc366069a4f56f(el) {
    el._x_effects?.forEach((0, $8d51fac66e0b4c1b$export$edbe2d8b64bcb07c));
...
function $d15872fa2e35871a$export$1dd40105af141b08(el, directive) {
    ...
    let wrapperHandler = (application)=>{
        let controller = $d15872fa2e35871a$var$getClosestController(el, directive.identifier, application);
        if (controller) {
            handler = handler.bind(handler, el, directive, {
                ...utilities,
                evaluate: $d15872fa2e35871a$var$evaluator(controller, el),
...
function $d15872fa2e35871a$var$evaluator(controller, el) {
    return (property)=>{
...
function $d15872fa2e35871a$var$getClosestController(el, identifier, application) {
...
function $694a8ddd6f476c7f$var$extend(application) {
    ...
    application.register = function(identifier, ControllerClass) {
        const controllerConstructor = $694a8ddd6f476c7f$var$createReactiveControllerClass(ControllerClass);
        application.load({
            identifier: identifier,
    ...
    (0, $46a1f2608b4b91f0$export$c395e4fde41c37ff)((el)=>$694a8ddd6f476c7f$var$initTree(el, application));
    ...
    (0, $46a1f2608b4b91f0$export$545f7104b1510552)((el, attrs)=>{
        $694a8ddd6f476c7f$var$handleValueAttributes(el, attrs, application);
        (0, $d15872fa2e35871a$export$90a684c00f3df6ed)(el, attrs).forEach((handle)=>handle(application));
    });
    (0, $8d51fac66e0b4c1b$export$bdd553fddd433dcb)(()=>{
        $694a8ddd6f476c7f$var$rootElements().forEach((el)=>$694a8ddd6f476c7f$var$initTree(el, application));
    });
}
function $694a8ddd6f476c7f$var$createReactiveControllerClass(ControllerClass) {
    return class extends ControllerClass {
        constructor(context){
            ...
            return (0, $ab22efe6fa499022$export$90a44edba14e47be)(this);
        }
    };
}
...
function $694a8ddd6f476c7f$var$initTree(el, application) {
    (0, $d15872fa2e35871a$export$3d81bdeca067fd2d)(()=>{
        $694a8ddd6f476c7f$var$walk(el, (el)=>{
            if (el._stimulus_x_marker) return;
            (0, $d15872fa2e35871a$export$90a684c00f3df6ed)(el, el.attributes).forEach((handle)=>handle(application));
            el._stimulus_x_marker = $694a8ddd6f476c7f$var$markerCount++;
        });
    });
}
function $694a8ddd6f476c7f$var$destroyTree(root) {
    $694a8ddd6f476c7f$var$walk(root, (el)=>{
        (0, $46a1f2608b4b91f0$export$21fc366069a4f56f)(el);
        (0, $46a1f2608b4b91f0$export$2c8bfe603cc113da)(el);
        delete el._stimulus_x_marker;
    });
}
function $694a8ddd6f476c7f$var$walk(el, callback) {
    let skip = false;
    callback(el, ()=>skip = true);
    if (skip) return;
    let node = el.firstElementChild;
    while(node){
        $694a8ddd6f476c7f$var$walk(node, callback, false);
...
function $694a8ddd6f476c7f$var$handleValueAttributes(el, attrs, application) {
...
var $694a8ddd6f476c7f$export$2e2bcd8739ae039 = {
    extend: $694a8ddd6f476c7f$var$extend,
...
var $10c5dcf5f1a88b39$exports = {};
var $d63ac99499eea7c6$exports = {};


function $3f6b9cf6aa95cce5$export$2385a24977818dd0(element, name, value) {
    switch(name){
        // case "class":
        ...
        case "checked":
        case "selected":
            $3f6b9cf6aa95cce5$var$bindAttributeAndProperty(element, name, value);
            break;
        default:
            $3f6b9cf6aa95cce5$var$bindAttribute(element, name, value);
            break;
    }
}
...
// }
function $3f6b9cf6aa95cce5$var$bindAttribute(el, name, value) {
    if ([
        null,
        undefined,
        false
    ].includes(value) && $3f6b9cf6aa95cce5$var$attributeShouldntBePreservedIfFalsy(name)) el.removeAttribute(name);
    else {
        if ($3f6b9cf6aa95cce5$var$isBooleanAttr(name)) value = name;
        $3f6b9cf6aa95cce5$var$setIfChanged(el, name, value);
    }
}
// function bindAll(element, obj) {
//   Object.keys(obj).forEach((name) => bind(element, name, getProperty(obj, name)));
// }
function $3f6b9cf6aa95cce5$var$bindAttributeAndProperty(el, name, value) {
    $3f6b9cf6aa95cce5$var$bindAttribute(el, name, value);
    $3f6b9cf6aa95cce5$var$setPropertyIfChanged(el, name, value);
}
function $3f6b9cf6aa95cce5$var$setIfChanged(el, attrName, value) {
    if (el.getAttribute(attrName) != value) el.setAttribute(attrName, value);
}
function $3f6b9cf6aa95cce5$var$setPropertyIfChanged(el, propName, value) {
    if (el[propName] !== value) el[propName] = value;
}
// As per HTML spec table https://html.spec.whatwg.org/multipage/indices.html#attributes-3:boolean-attribute
const $3f6b9cf6aa95cce5$var$booleanAttributes = new Set([
    "allowfullscreen",
    "async",
    "autofocus",
    "autoplay",
...
function $3f6b9cf6aa95cce5$var$isBooleanAttr(attrName) {
    return $3f6b9cf6aa95cce5$var$booleanAttributes.has(attrName);
}
function $3f6b9cf6aa95cce5$var$attributeShouldntBePreservedIfFalsy(name) {
    return ![
        "aria-pressed",
        "aria-checked",
        "aria-expanded",
...
(0, $d15872fa2e35871a$export$99b43ad1ed32e735)("attr", (el, { property: property, subject: subject, modifiers: modifiers }, { effect: effect, evaluate: evaluate, modify: modify })=>{
    effect(()=>{
        (0, $46a1f2608b4b91f0$export$c98382a3d82f9519)(()=>{
            ...
            (0, $3f6b9cf6aa95cce5$export$2385a24977818dd0)(el, subject, value);
        });
    });
});


var $14d6fa46eff32b29$exports = {};
...
$10c5dcf5f1a88b39$exports = {
    "attr": $d63ac99499eea7c6$exports,
    "text": $14d6fa46eff32b29$exports
};


var $84e2b807bb027f93$exports = {};
var $8445d862d628c8ea$exports = {};

(0, $76daf8d022148001$export$cd4b50bb4e5c05a3)("downcase", (value)=>value.toString().toLowerCase());


var $f89425736d994880$exports = {};

(0, $76daf8d022148001$export$cd4b50bb4e5c05a3)("not", (value)=>!value);


var $5eb7665a7bd73d07$exports = {};

(0, $76daf8d022148001$export$cd4b50bb4e5c05a3)("upcase", (value)=>value.toString().toUpperCase());


$84e2b807bb027f93$exports = {
    "downcase": $8445d862d628c8ea$exports,
    "not": $f89425736d994880$exports,
    "upcase": $5eb7665a7bd73d07$exports
};
...
export {$d832f2ef8a5ce6ac$export$2e2bcd8739ae039 as default, $694a8ddd6f476c7f$export$2e2bcd8739ae039 as StimulusX, $8d51fac66e0b4c1b$export$bdd553fddd433dcb as nextTick};
